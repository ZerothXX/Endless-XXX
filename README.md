...
项目参考自Honkai: Star Rail的网页活动：[无尽的三月七](https://bbs.mihoyo.com/sr/wiki/content/1244/detail?bbs_presentation_style=no_header)，项目旨在复刻实现该网页活动，但在效果和实现方面做了相应调整，该项目可通过少量图片训练来切换角色而非单一角色，该项目也尽量保留了原图的画风及相应人或物的本体效果。
...
人物场景希望以角色身份、脸部和服装特征为主，原图画风作为适度点缀。
